                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('food.delete', $item->id) }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Food Edit
                                                                </h5>
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <form class="forms-sample"
                                                                                    action="{{ route('food.edit', $item->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                ...
                                <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample" action="{{ route('food.create') }}"
                                                method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="name">Name</label>

    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title">Outdoor media management</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Outdoor media management</li>
                    </ol>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('outdoor_media_management.update', $item->id) }}"
                                                        class="btn btn-warning btn-sm"> <i class="mdi mdi-pencil"></i></a>
                                                    <a href="{{ route('outdoor_media_management.delete', $item->id) }}"
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Outdoor media management Add</h5>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="forms-sample"
                                                action="{{ route('outdoor_media_management.create') }}"
